...
private:
     ...
     * @return true on success, false otherwise.
     */
    bool _configure_data_io(bool enable);
    ...
    /**
     * Read raw data from gyro module , process and notify.
     */
	void _read_data_gyro();

    /**
     * Read raw data from accel module , process and notify.
     */
	void _read_data_accel();

    /**
     * Read raw data from temperature module , process and notify.
     */
	void _read_data_temperature();

    /**
     * Check imu product id.
     */
	bool _check_whoami();

	/**
     * Reset imu by software.
     */
	bool _reset();

	/**
     * Make imu work in test mode.
     */
	bool _test_myself();

	/**
     * Take imu offset zero.
     */
	bool _offset_zero();
