/*
  Z6ka7 Servo controlled mount backend class
 */
#pragma once
...
class AP_Mount_Z6ka7_Servo : public AP_Mount_Backend
{
public:
    // Constructor
    AP_Mount_Z6ka7_Servo(AP_Mount &frontend, AP_Mount::mount_state &state, uint8_t instance):
